...
$APPLICATION->AddHeadString('<script src="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.js"></script>');
?>
...
<?php $APPLICATION->AddHeadScript(SITE_TEMPLATE_PATH . "/components/bitrix/news.list/infrastructure/script.js"); ?>
<section class="home-infra">
    <div class="container">
        <header class="home-infra__head">
            <h2 class="home-infra__title">Инфраструктура мирового уровня</h2>
            <a href="/infrastructure/" class="btn-pill btn-pill--dark">Производство</a>
        </header>
        <div class="home-infra__body">
