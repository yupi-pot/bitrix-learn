this.BX=this.BX||{};this.BX.Bizproc=this.BX.Bizproc||{};(function(e,s,i,t,a,l,r,o,n){"use strict";let c=e=>e,d,b;var p=babelHelpers.classPrivateFieldLooseKey("errors");class v{constructor(e){Object.defineProperty(this,p,{writable:true,value:[]});if(n.Type.isArrayFilled(e.errors)){babelHelpers.classPrivateFieldLooseBase(this,p)[p]=e.errors}}render(){return n.Tag.render(d||(d=c`
		...
		`),babelHelpers.classPrivateFieldLooseBase(this,p)[p].map((({message:e})=>n.Tag.render(b||(b=c`
					...
					`),n.Text.encode(e)))))}renderTo(e){n.Dom.append(this.render(),e)}}var u=babelHelpers.classPrivateFieldLooseKey("data");class L{constructor(e){Object.defineProperty(this,u,{writable:true,value:{}});if(n.Type.isPlainObject(e)){babelHelpers.classPrivateFieldLooseBase(this,u)[u]=e}}canView(){return n.Type.isBoolean(babelHelpers.classPrivateFieldLooseBase(this,u)[u].canView)?babelHelpers.classPrivateFieldLooseBase(this,u)[u].canView:false}get status(){return new o.TaskStatus(babelHelpers.classPrivateFieldLooseBase(this,u)[u].status)}get id(){return n.Type.isInteger(babelHelpers.classPrivateFieldLooseBase(this,u)[u].id)?babelHelpers.classPrivateFieldLooseBase(this,u)[u].id:0}get name(){return n.Type.isString(babelHelpers.classPrivateFieldLooseBase(this,u)[u].name)?babelHelpers.classPrivateFieldLooseBase(this,u)[u].name:""}get modified(){return n.Type.isInteger(babelHelpers.classPrivateFieldLooseBase(this,u)[u].modified)?Math.max(babelHelpers.classPrivateFieldLooseBase(this,u)[u].modified,0):0}get users(){return n.Type.isArray(babelHelpers.classPrivateFieldLooseBase(this,u)[u].users)?babelHelpers.classPrivateFieldLooseBase(this,u)[u].users:[]}get executionTime(){return n.Type.isInteger(babelHelpers.classPrivateFieldLooseBase(this,u)[u].executionTime)?Math.max(babelHelpers.classPrivateFieldLooseBase(this,u)[u].executionTime,0):null}get approveType(){return n.Type.isString(babelHelpers.classPrivateFieldLooseBase(this,u)[u].approveType)?babelHelpers.classPrivateFieldLooseBase(this,u)[u].approveType:""}get url(){return n.Type.isStringFilled(babelHelpers.classPrivateFieldLooseBase(this,u)[u].url)?babelHelpers.classPrivateFieldLooseBase(this,u)[u].url:null}}let P=e=>e,f,F,h,I,m,B,_,O;const E=60*60*24*3;var T=babelHelpers.classPrivateFieldLooseKey("task");var H=babelHelpers.classPrivateFieldLooseKey("userId");var g=babelHelpers.classPrivateFieldLooseKey("taskNumber");var w=babelHelpers.classPrivateFieldLooseKey("dateFormat");var R=babelHelpers.classPrivateFieldLooseKey("dateFormatShort");var y=babelHelpers.classPrivateFieldLooseKey("users");var k=babelHelpers.classPrivateFieldLooseKey("renderContent");var M=babelHelpers.classPrivateFieldLooseKey("renderButton");var S=babelHelpers.classPrivateFieldLooseKey("renderStatus");var N=babelHelpers.classPrivateFieldLooseKey("getStatusName");var K=babelHelpers.classPrivateFieldLooseKey("renderUsers");var W=babelHelpers.classPrivateFieldLooseKey("renderUser");var D=babelHelpers.classPrivateFieldLooseKey("renderExecutionTime");var z=babelHelpers.classPrivateFieldLooseKey("renderAccessDenied");class C{constructor(e){Object.defineProperty(this,z,{value:G});Object.defineProperty(this,D,{value:X});Object.defineProperty(this,W,{value:U});Object.defineProperty(this,K,{value:A});Object.defineProperty(this,N,{value:Z});Object.defineProperty(this,S,{value:x});Object.defineProperty(this,M,{value:j});Object.defineProperty(this,k,{value:$});Object.defineProperty(this,T,{writable:true,value:void 0});Object.defineProperty(this,H,{writable:true,value:0});Object.defineProperty(this,g,{writable:true,value:null});Object.defineProperty(this,w,{writable:true,value:void 0});Object.defineProperty(this,R,{writable:true,value:void 0});Object.defineProperty(this,y,{writable:true,value:void 0});babelHelpers.classPrivateFieldLooseBase(this,T)[T]=e.task;babelHelpers.classPrivateFieldLooseBase(this,w)[w]=e.dateFormat;babelHelpers.classPrivateFieldLooseBase(this,R)[R]=e.dateFormatShort;babelHelpers.classPrivateFieldLooseBase(this,y)[y]=e.users;if(n.Type.isNumber(e.taskNumber)&&e.taskNumber>0){babelHelpers.classPrivateFieldLooseBase(this,g)[g]=e.taskNumber}if(n.Type.isNumber(e.userId)&&e.userId>0){babelHelpers.classPrivateFieldLooseBase(this,H)[H]=e.userId}}renderTo(e){n.Dom.append(this.render(),e)}render(){return babelHelpers.classPrivateFieldLooseBase(this,T)[T].canView()?babelHelpers.classPrivateFieldLooseBase(this,k)[k]():babelHelpers.classPrivateFieldLooseBase(this,z)[z]()}}function $(){const e=babelHelpers.classPrivateFieldLooseBase(this,T)[T].status.isWaiting();return n.Tag.render(f||(f=P`
		...
		`),e?"--processing":"",e?"--processing":"--success",e?"":babelHelpers.classPrivateFieldLooseBase(this,g)[g]||"",n.Text.encode(babelHelpers.classPrivateFieldLooseBase(this,T)[T].name),babelHelpers.classPrivateFieldLooseBase(this,M)[M](),n.Text.encode(he.formatDate(babelHelpers.classPrivateFieldLooseBase(this,T)[T].modified,babelHelpers.classPrivateFieldLooseBase(this,w)[w],babelHelpers.classPrivateFieldLooseBase(this,R)[R])),babelHelpers.classPrivateFieldLooseBase(this,S)[S](),babelHelpers.classPrivateFieldLooseBase(this,K)[K](),babelHelpers.classPrivateFieldLooseBase(this,D)[D]())}function j(){if(babelHelpers.classPrivateFieldLooseBase(this,H)[H]===0||!babelHelpers.classPrivateFieldLooseBase(this,T)[T].url){return null}const e=babelHelpers.classPrivateFieldLooseBase(this,T)[T].users.find((e=>e.id===babelHelpers.classPrivateFieldLooseBase(this,H)[H]));if(n.Type.isUndefined(e)){return null}const s=new o.UserStatus(e.status).isWaiting();return n.Tag.render(F||(F=P`
			<a
				class="
		...
		`),n.Text.encode(n.Loc.getMessage("BIZPROC_WORKFLOW_TIMELINE_SLIDER_EXECUTION_TIME")),n.Text.encode(he.formatTimeInterval(e,2)),s?i:null);if(s){BX.UI.Hint.init(t)}return t}function G(){return n.Tag.render(O||(O=P`
		...
		`),e)}function Fs(e,s,i){const t=n.Type.isString(s)?` ${s}`:"";const a=n.Type.isString(i)?` data-efficiency-class="${i}"`:"";return n.Tag.render(re||(re=Y`
			<div class="bizproc-workflow-timeline-item${0}"${0}>
				<div class="bizproc-workflow-timeline-item-inner">
					${0}
				</div>
			</div>
		`),t,a,e)}function hs(e){return n.Tag.render(oe||(oe=Y`
		...
		`),e)}function Is(){const e=[];if(babelHelpers.classPrivateFieldLooseBase(this,_e)[_e].startedBy){e.push(babelHelpers.classPrivateFieldLooseBase(this,De)[De](n.Loc.getMessage("BIZPROC_WORKFLOW_TIMELINE_SLIDER_FROM")),babelHelpers.classPrivateFieldLooseBase(this,Ke)[Ke](babelHelpers.classPrivateFieldLooseBase(this,_e)[_e].startedBy))}e.push(babelHelpers.classPrivateFieldLooseBase(this,We)[We](babelHelpers.classPrivateFieldLooseBase(this,_e)[_e].document.name,babelHelpers.classPrivateFieldLooseBase(this,_e)[_e].document.url,babelHelpers.classPrivateFieldLooseBase(this,_e)[_e].document.moduleName,"--file-2"));if(!n.Type.isNil(babelHelpers.classPrivateFieldLooseBase(this,_e)[_e].timeToStart)){e.push(babelHelpers.classPrivateFieldLooseBase(this,ze)[ze](n.Loc.getMessage("BIZPROC_WORKFLOW_TIMELINE_SLIDER_EXECUTION_TIME"),he.formatTimeInterval(babelHelpers.classPrivateFieldLooseBase(this,_e)[_e].timeToStart,2)))}return babelHelpers.classPrivateFieldLooseBase(this,xe)[xe]([babelHelpers.classPrivateFieldLooseBase(this,Me)[Me](babelHelpers.classPrivateFieldLooseBase(this,_e)[_e].document.entityName,"--success","1"),babelHelpers.classPrivateFieldLooseBase(this,_e)[_e].started&&babelHelpers.classPrivateFieldLooseBase(this,Se)[Se](he.formatDate(babelHelpers.classPrivateFieldLooseBase(this,_e)[_e].started,babelHelpers.classPrivateFieldLooseBase(this,ge)[ge],babelHelpers.classPrivateFieldLooseBase(this,we)[we])),babelHelpers.classPrivateFieldLooseBase(this,je)[je](e)],"--selected")}function ms(){const e=[];let s="";let i=false;if(babelHelpers.classPrivateFieldLooseBase(this,_e)[_e]){let t=null;e.push(babelHelpers.classPrivateFieldLooseBase(this,Ae)[Ae]());let a=1;let l=babelHelpers.classPrivateFieldLooseBase(this,_e)[_e].tasks[0]?!babelHelpers.classPrivateFieldLooseBase(this,_e)[_e].tasks[0].status.isWaiting():true;for(const s of Object.keys(babelHelpers.classPrivateFieldLooseBase(this,_e)[_e].tasks)){t=babelHelpers.classPrivateFieldLooseBase(this,_e)[_e].tasks[s];i=t.status.isWaiting();if(!i){++a}const r=new C({task:t,userId:n.Text.toInteger(n.Loc.getMessage("USER_ID")),dateFormat:babelHelpers.classPrivateFieldLooseBase(this,ge)[ge],dateFormatShort:babelHelpers.classPrivateFieldLooseBase(this,we)[we],taskNumber:i?null:a,users:babelHelpers.classPrivateFieldLooseBase(this,_e)[_e].users});const o=r.render();if(!i&&l){n.Dom.addClass(o,"--hidden")}if(i&&l){e.push(babelHelpers.classPrivateFieldLooseBase(this,$e)[$e]());l=false}e.push(o)}if(l&&babelHelpers.classPrivateFieldLooseBase(this,_e)[_e].tasks[0]){e.push(babelHelpers.classPrivateFieldLooseBase(this,$e)[$e]())}if(babelHelpers.classPrivateFieldLooseBase(this,_e)[_e].isWorkflowRunning){if(i){e.push(babelHelpers.classPrivateFieldLooseBase(this,xe)[xe]([babelHelpers.classPrivateFieldLooseBase(this,Me)[Me](n.Loc.getMessage("BIZPROC_WORKFLOW_TIMELINE_SLIDER_IN_PROGRESS")),babelHelpers.classPrivateFieldLooseBase(this,Se)[Se](n.Loc.getMessage("BIZPROC_WORKFLOW_TIMELINE_SLIDER_IN_PROGRESS_TIP"))],"--tech --previous-item"))}else{e.push(babelHelpers.classPrivateFieldLooseBase(this,xe)[xe]([babelHelpers.classPrivateFieldLooseBase(this,Me)[Me](n.Loc.getMessage("BIZPROC_WORKFLOW_TIMELINE_SLIDER_IN_PROGRESS_INTERMEDIATE")),babelHelpers.classPrivateFieldLooseBase(this,Se)[Se](n.Loc.getMessage("BIZPROC_WORKFLOW_TIMELINE_SLIDER_IN_PROGRESS_INTERMEDIATE_TIP"))],"--tech --previous-item"))}}else{const i=!t||t.status.isOk()||t.status.isYes();const a=[babelHelpers.classPrivateFieldLooseBase(this,De)[De](n.Loc.getMessage("BIZPROC_WORKFLOW_TIMELINE_SLIDER_PROCESS_FINISHED"))];if(babelHelpers.classPrivateFieldLooseBase(this,_e)[_e].startedBy){a.push(i?babelHelpers.classPrivateFieldLooseBase(this,Ce)[Ce](n.Loc.getMessage("BIZPROC_WORKFLOW_TIMELINE_SLIDER_APPROVED_FOR")):babelHelpers.classPrivateFieldLooseBase(this,Ce)[Ce](n.Loc.getMessage("BIZPROC_WORKFLOW_TIMELINE_SLIDER_DECLINED"),"--failure"),babelHelpers.classPrivateFieldLooseBase(this,Ke)[Ke](babelHelpers.classPrivateFieldLooseBase(this,_e)[_e].startedBy))}a.push(babelHelpers.classPrivateFieldLooseBase(this,ze)[ze](n.Loc.getMessage("BIZPROC_WORKFLOW_TIMELINE_SLIDER_PROCESS_EXECUTED"),he.formatTimeInterval(babelHelpers.classPrivateFieldLooseBase(this,_e)[_e].executionTime)));s=i?"--success":"--declined";e.push(babelHelpers.classPrivateFieldLooseBase(this,xe)[xe]([babelHelpers.classPrivateFieldLooseBase(this,Me)[Me](babelHelpers.classPrivateFieldLooseBase(this,_e)[_e].document.entityName,i?"--success":null),babelHelpers.classPrivateFieldLooseBase(this,_e)[_e].started&&babelHelpers.classPrivateFieldLooseBase(this,Se)[Se](he.formatDate(babelHelpers.classPrivateFieldLooseBase(this,_e)[_e].started+babelHelpers.classPrivateFieldLooseBase(this,_e)[_e].executionTime,babelHelpers.classPrivateFieldLooseBase(this,ge)[ge],babelHelpers.classPrivateFieldLooseBase(this,we)[we])),babelHelpers.classPrivateFieldLooseBase(this,je)[je](a)],i?"--success --previous":"--declined --selected --previous",s),babelHelpers.classPrivateFieldLooseBase(this,Ve)[Ve]())}}return babelHelpers.classPrivateFieldLooseBase(this,Ze)[Ze](e)}function Bs(){const e=document.querySelectorAll('[data-crop="crop"]');for(const s of e){const e=new a.TextCrop({rows:2,target:s});e.init()}}function _s(){babelHelpers.classPrivateFieldLooseBase(this,Re)[Re]=new l.Popup({width:403,minHeight:345,closeIcon:true,content:babelHelpers.classPrivateFieldLooseBase(this,qe)[qe](),bindElement:{left:555,top:130},padding:26,borderRadius:"18px",className:"--bizproc-timeline-popup",events:{onPopupClose:()=>{let e=document.querySelector(".--previous-item");if(!e){e=document.querySelector(".bizproc-workflow-timeline-item.--processing")}if(!e){return}BX.Dom.addClass(e,"--previous");let s=e.getAttribute("data-efficiency-class");if(!s){s=""}e.after(babelHelpers.classPrivateFieldLooseBase(this,Ve)[Ve](s))}}});return babelHelpers.classPrivateFieldLooseBase(this,Re)[Re]}function Os(){let e="--first";let s=n.Loc.getMessage("BIZPROC_WORKFLOW_TIMELINE_SLIDER_NO_STATS");switch(babelHelpers.classPrivateFieldLooseBase(this,_e)[_e].stats.efficiency){case"fast":e="--fast";s=n.Loc.getMessage("BIZPROC_WORKFLOW_TIMELINE_SLIDER_PERFORMED_QUICKLY");break;case"slow":e="--slow";s=n.Loc.getMessage("BIZPROC_WORKFLOW_TIMELINE_SLIDER_PERFORMED_SLOWLY");break;case"stopped":e="--stopped";s=n.Loc.getMessage("BIZPROC_WORKFLOW_TIMELINE_SLIDER_PERFORMED_NO_PROGRESS");break;default:break}return[e,s]}function Es(e){const[s,i]=babelHelpers.classPrivateFieldLooseBase(this,Ye)[Ye]();const t=n.Tag.render(ne||(ne=Y`
		...
		`),e,n.Loc.getMessage("BIZPROC_WORKFLOW_TIMELINE_SLIDER_EFFECTIVITY_MARK"),s,i,n.Loc.getMessage("BIZPROC_WORKFLOW_TIMELINE_SLIDER_CURRENT_PROCESS_TIME"),he.formatTimeInterval(babelHelpers.classPrivateFieldLooseBase(this,_e)[_e].executionTime),n.Loc.getMessage("BIZPROC_WORKFLOW_TIMELINE_SLIDER_TIME_DIFFERENCE_MSGVER_1"),n.Loc.getMessage("BIZPROC_WORKFLOW_TIMELINE_SLIDER_AVERAGE_PROCESS_TIME"),babelHelpers.classPrivateFieldLooseBase(this,_e)[_e].stats.averageDuration===null?n.Loc.getMessage("BIZPROC_WORKFLOW_TIMELINE_SLIDER_AVERAGE_PROCESS_TIME_UNKNOWN"):he.formatTimeInterval(babelHelpers.classPrivateFieldLooseBase(this,_e)[_e].stats.averageDuration));BX.UI.Hint.init(t);return t}function Ts(){const[e,s]=babelHelpers.classPrivateFieldLooseBase(this,Ye)[Ye]();const i=n.Tag.render(ce||(ce=Y`
		...
		`),n.Loc.getMessage("BIZPROC_WORKFLOW_TIMELINE_SLIDER_EFFECTIVITY_MARK"),e,s,he.formatTimeInterval(babelHelpers.classPrivateFieldLooseBase(this,_e)[_e].executionTime),n.Loc.getMessage("BIZPROC_WORKFLOW_TIMELINE_SLIDER_TIME_DIFFERENCE_MSGVER_1"),n.Loc.getMessage("BIZPROC_WORKFLOW_TIMELINE_SLIDER_CURRENT_PROCESS_TIME"),he.formatTimeInterval(babelHelpers.classPrivateFieldLooseBase(this,_e)[_e].stats.averageDuration),n.Loc.getMessage("BIZPROC_WORKFLOW_TIMELINE_SLIDER_AVERAGE_PROCESS_TIME"),n.Loc.getMessage("BIZPROC_WORKFLOW_TIMELINE_SLIDER_PERFORMANCE_TUNING_TIP"),n.Loc.getMessage("BIZPROC_WORKFLOW_TIMELINE_SLIDER_PERFORMANCE_TUNING_LINK"));BX.UI.Hint.init(i);return i}function Hs(e){const s=document.querySelector('[data-role="page-toolbar"]');if(!s){return}if(e.length===1){const i=n.Tag.render(de||(de=Y`
				<a class="ui-btn ui-btn-light-border ui-btn-themes" onclick="${0}" target="_blank">
					${0}
				</a>
			`),n.Text.encode(e[0].ON_CLICK),n.Text.encode(n.Loc.getMessage("BIZPROC_WORKFLOW_TIMELINE_SLIDER_BI_ANALYTICS_BUTTON")));n.Dom.prepend(i,s);return}const i=babelHelpers.classPrivateFieldLooseBase(this,ss)[ss].bind(this,e);const t=n.Tag.render(be||(be=Y`
			<button class="ui-btn ui-btn-light-border ui-btn-themes ui-btn-dropdown" onclick="${0}">
				${0}
			</button>
		`),i,n.Text.encode(n.Loc.getMessage("BIZPROC_WORKFLOW_TIMELINE_SLIDER_BI_ANALYTICS_BUTTON")));n.Dom.prepend(t,s)}function gs(e){babelHelpers.classPrivateFieldLooseBase(this,He)[He]=new l.Popup({width:403,minHeight:183,closeIcon:true,content:babelHelpers.classPrivateFieldLooseBase(this,is)[is](e),bindElement:{left:555,top:babelHelpers.classPrivateFieldLooseBase(this,es)[es]()},padding:17,borderRadius:"18px",className:"--bizproc-timeline-popup --bi"});return babelHelpers.classPrivateFieldLooseBase(this,He)[He]}function ws(){var e,s,i,t;const a=(e=babelHelpers.classPrivateFieldLooseBase(this,Re)[Re])==null?void 0:(s=e.getPopupContainer())==null?void 0:s.offsetHeight;const l=(i=babelHelpers.classPrivateFieldLooseBase(this,Re)[Re])==null?void 0:(t=i.bindElementPos)==null?void 0:t.top;if(a&&l){return a+l+20}return 522}function Rs(e,s){new l.Menu({bindElement:s.target,items:e.map((e=>({text:e.TEXT,onclick:e.ON_CLICK})))}).show()}function ys(e){let s=null;if(e.length===1){s=n.Tag.render(pe||(pe=Y`
				<a class="ui-btn ui-btn-light-border ui-btn-round ui-btn-xs" onclick="${0}" target="_blank">
					<span class="ui-btn-text">${0}</span>
				</a>
			`),n.Text.encode(e[0].ON_CLICK),n.Loc.getMessage("BIZPROC_WORKFLOW_TIMELINE_SLIDER_BI_ANALYTICS_LINK"))}else{const i=babelHelpers.classPrivateFieldLooseBase(this,ss)[ss].bind(this,e);s=n.Tag.render(ve||(ve=Y`
				<a 
		...
		`))}function Ms(){return babelHelpers.classPrivateFieldLooseBase(this,Ee)[Ee].length>0}e.DurationFormatter=he;e.Timeline=ls})(this.BX.Bizproc.Workflow=this.BX.Bizproc.Workflow||{},BX.Bizproc,BX.Bizproc,BX,BX.UI,BX.Main,BX.Main,BX.Bizproc,BX);
