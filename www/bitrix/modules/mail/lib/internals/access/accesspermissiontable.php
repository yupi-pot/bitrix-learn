 ...
 * @method static \Bitrix\Mail\Internals\Access\EO_AccessPermission createObject($setDefaultValues = true)
 * @method static \Bitrix\Mail\Internals\Access\EO_AccessPermission_Collection createCollection()
 * @method static \Bitrix\Mail\Internals\Access\EO_AccessPermission wakeUpObject($row)
 * @method static \Bitrix\Mail\Internals\Access\EO_AccessPermission_Collection wakeUpCollection($rows)
 */
class AccessPermissionTable extends Main\Access\Permission\AccessPermissionTable
{
	public static function getTableName(): string
	{
		return 'b_mail_access_permission';
	}
}