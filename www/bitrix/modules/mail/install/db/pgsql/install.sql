...
CREATE TABLE b_mail_access_role (
	ID BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
	NAME VARCHAR(250) NOT NULL,
	PRIMARY KEY (ID)
);

CREATE TABLE b_mail_access_permission (
	ID BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
CREATE INDEX IF NOT EXISTS IX_B_MAIL_ACCESS_PERMISSION_ROLE_ID ON b_mail_access_permission (ROLE_ID);
CREATE INDEX IF NOT EXISTS IX_B_MAIL_ACCESS_PERMISSION_PERMISSION_ID ON b_mail_access_permission (PERMISSION_ID);


CREATE TABLE b_mail_access_role_relation (
	ID BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
	ROLE_ID INT NOT NULL,
...
CREATE INDEX IF NOT EXISTS IX_B_MAIL_ACCESS_ROLE_RELATION_ROLE_ID ON b_mail_access_role_relation (ROLE_ID);
CREATE INDEX IF NOT EXISTS IX_B_MAIL_ACCESS_ROLE_RELATION_RELATION ON b_mail_access_role_relation (RELATION);

CREATE TABLE b_mail_mass_connect (
	ID BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
...
CREATE TABLE b_mail_mailbox_list_search_index (
	ID BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
	MAILBOX_ID INT NOT NULL,
	SEARCH_INDEX TEXT,
	PRIMARY KEY (ID)
...
CREATE INDEX IF NOT EXISTS IXF_B_MAIL_MAILBOX_LIST_INDEX_SEARCH_INDEX ON b_mail_mailbox_list_search_index USING GIN (to_tsvector('english', SEARCH_INDEX));
