...
$MESS["BLG_GCT_ERROR_NO_BLOG"] = "Blog with ID '#ID#' cannot be found";
$MESS["BLG_GCT_ERROR_NO_POST"] = "Post with ID '#ID#' cannot be found";
$MESS["BLG_GCT_ERROR_NO_CATEGORY"] = "Tag with ID '#ID#' cannot be found";
