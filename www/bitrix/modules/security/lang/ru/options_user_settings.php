...
$MESS['SEC_OTP_WAITING_INSTALL'] = 'Ожидаем установку приложения...';
$MESS['SEC_OTP_PUSH_ERROR'] = 'Не удалось подключить мобильное приложение. Проверьте настройки времени на телефоне и повторите подключение.';
$MESS['SECT_OTP_PUSH_DESC'] = 'Установите <b>мобильное приложение Битрикс24</b>. Приложение будет использоваться для подтверждения входа в Битрикс24.';
$MESS['SEC_OTP_PUSH_STEP1'] = 'Убедитесь, что на телефоне правильно настроено время и часовой пояс, иначе подключиться не получится.';
$MESS['SEC_OTP_PUSH_STEP2'] = 'Наведите камеру телефона на QR-код.';
$MESS['SEC_OTP_PUSH_STEP3'] = 'Перейдите по ссылке на экране телефона.';
