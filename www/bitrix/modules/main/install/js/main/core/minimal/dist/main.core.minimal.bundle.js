...
(function (exports) {
	...
	let Easing = /*#__PURE__*/function () {
	  function Easing(easingOptions) {
	    ...
	    _classPrivateMethodInitSpec$1(this, _animate);
	    _classPrivateFieldInitSpec$1(this, _duration, {
	      writable: true,
	      value: 1000
	    });
	    _classPrivateFieldInitSpec$1(this, _transition, {
	      writable: true,
	      value: Transition.linear
	    });
	    _classPrivateFieldInitSpec$1(this, _begin, {
	      writable: true,
	      value: null
	    });
	    _classPrivateFieldInitSpec$1(this, _step, {
	      writable: true,
	      value: null
	    });
	    _classPrivateFieldInitSpec$1(this, _complete, {
	      writable: true,
	      value: null
	    });
	    _classPrivateFieldInitSpec$1(this, _start, {
	      writable: true,
	      value: {}
	    });
	    _classPrivateFieldInitSpec$1(this, _finish, {
	      writable: true,
	      value: {}
	    });
	    _classPrivateFieldInitSpec$1(this, _currentState, {
	      writable: true,
	      value: {}
	    });
	    _classPrivateFieldInitSpec$1(this, _progress, {
	      writable: true,
	      value: null
	    });
	    _classPrivateFieldInitSpec$1(this, _timer, {
	      writable: true,
	      value: null
	    });
	  ...
	  babelHelpers.createClass(Easing, [{
	    ...
	    value: function animateProgress() {
	      _classPrivateMethodGet$1(this, _animate, _animate2).call(this);
	    }
	  }, {
	    key: "animate",
	...
	let LocalStorage = /*#__PURE__*/function () {
	  function LocalStorage(storageOptions = {}) {
	    ...
	    _classPrivateMethodInitSpec$2(this, _isValueValid);
	    _classPrivateMethodInitSpec$2(this, _parseValue);
	    _classPrivateMethodInitSpec$2(this, _getRealValue);
	    _classPrivateMethodInitSpec$2(this, _decode);
	    _classPrivateMethodInitSpec$2(this, _encode);
	    _classPrivateMethodInitSpec$2(this, _clear);
	    _classPrivateMethodInitSpec$2(this, _handleStorageChange);
	    _classPrivateMethodInitSpec$2(this, _setPrefix);
	    _classPrivateFieldInitSpec$2(this, _prefix, {
	      writable: true,
	      value: null
	    });
	    const options = Type.isPlainObject(storageOptions) ? storageOptions : {};
	    _classPrivateMethodGet$2(this, _setPrefix, _setPrefix2).call(this, options.prefix);
	    Event.bind(window, 'storage', _classPrivateMethodGet$2(this, _handleStorageChange, _handleStorageChange2).bind(this));
	    setInterval(_classPrivateMethodGet$2(this, _clear, _clear2).bind(this), 5000);
	  }
	  babelHelpers.createClass(LocalStorage, [{
	    ...
	    value: function set(key, value, ttl = 60) {
	      ...
	      try {
	        window.localStorage.setItem(this.getPrefix() + key, `${Math.round(Date.now() / 1000) + ttl}:${_classPrivateMethodGet$2(this, _encode, _encode2).call(this, value)}`);
	      } catch {
	    ...
	    value: function get(key) {
	      ...
	      if (storageValue) {
	        const valueParts = _classPrivateMethodGet$2(this, _parseValue, _parseValue2).call(this, storageValue);
	        if (valueParts === null) {
	          return null;
	        }
	        const [ttl, value] = valueParts;
	        if (Date.now() <= ttl) {
	          return _classPrivateMethodGet$2(this, _decode, _decode2).call(this, value);
	        }
	        this.remove(key);
	      }
	      return null;
	...
	function _handleStorageChange2(event) {
	  ...
	  const value = _classPrivateMethodGet$2(this, _getRealValue, _getRealValue2).call(this, event.newValue);
	  const oldValue = _classPrivateMethodGet$2(this, _getRealValue, _getRealValue2).call(this, event.oldValue);
	  const data = {
	    key,
	    value,
	    oldValue
	...
	function _clear2() {
	  ...
	  for (let i = 0; i < window.localStorage.length; i++) {
	    ...
	    if (key.startsWith(this.getBasePrefix())) {
	      ...
	      const valueParts = _classPrivateMethodGet$2(this, _parseValue, _parseValue2).call(this, value);
	      if (valueParts === null) {
	        continue;
	      }
	...
	function _getRealValue2(value) {
	  ...
	  return _classPrivateMethodGet$2(this, _decode, _decode2).call(this, valueParts[1]);
	}
	function _parseValue2(value) {
	  if (!_classPrivateMethodGet$2(this, _isValueValid, _isValueValid2).call(this, value)) {
	    return null;
	  }
