...
CREATE INDEX ix_b_user_external_auth_id_active ON b_user (external_auth_id, active);
CREATE INDEX ix_b_user_personal_birthdate ON b_user (personal_birthdate);
...
CREATE INDEX ix_b_user_option_category_name ON b_user_option (category, name);
...
CREATE INDEX ix_b_user_access_access_code_user_id ON b_user_access (access_code, user_id);
...
CREATE INDEX ix_b_consent_user_consent_agreement_id_user_id ON b_consent_user_consent (agreement_id, user_id);
