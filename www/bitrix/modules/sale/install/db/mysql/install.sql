...
(
	...
	DISCOUNT_PRICE decimal(26,8) not null,
...
(
	...
	PRICE_DELIVERY decimal(26,8) NOT NULL,
	PRICE_PAYMENT decimal(26,8) NOT NULL,
	...
	PRICE decimal(26,8) not null,
	CURRENCY char(3) not null,
	DISCOUNT_VALUE decimal(26,8) NOT NULL,
	USER_ID int not null,
	...
	PS_SUM decimal(26,8) null,
	PS_CURRENCY char(3) null,
	PS_RESPONSE_DATE datetime null,
	COMMENTS text null,
	TAX_VALUE decimal(26,8) not null,
	STAT_GID varchar(255) null,
	SUM_PAID decimal(26,8) not null default '0',
	...
	fulltext index IX_B_SALE_ORDER_SEARCH (SEARCH_CONTENT)
);
...
(
	...
	PRICE_FROM decimal(26,8) null,	-- deprecated
	PRICE_TO decimal(26,8) null,	-- deprecated
	CURRENCY char(3) null,
	DISCOUNT_VALUE decimal(26,8) not null,	-- deprecated
...
(
	...
	VALUE_MONEY decimal(26,8) not null,
...
(
	...
	USER_ID int not null,
	TIMESTAMP_X datetime not null,
	CURRENT_BUDGET decimal(26,8) not null default '0.0',
	CURRENCY char(3) not null,
...
(
	...
	DESCRIPTION varchar(255) null,
	SUM_MIN decimal(26,8) null,
	SUM_MAX decimal(26,8) null,
...
(
	...
	AMOUNT decimal(26,8) not null default '0.0',
	CURRENCY char(3) not null,
...
(
	...
	MIN_PAY decimal(26,8) not null default '0',
	MIN_PLAN_VALUE decimal(26,8) null,
...
(
	...
	PAID_SUM decimal(26,8) not null default '0',
	APPROVED_SUM decimal(26,8) not null default '0',
	PENDING_SUM decimal(26,8) not null default '0',
	ITEMS_NUMBER int not null default '0',
	ITEMS_SUM decimal(26,8) not null default '0',
...
create table if not exists b_sale_viewed_product (
	...
	CURRENCY char(3) NULL,
	PRICE decimal(26,8) NOT NULL DEFAULT '0.00',
...
create table if not exists b_sale_order_history (
	...
	PRICE_DELIVERY decimal(26,8) null,
	...
	CURRENCY char(3) null,
	DISCOUNT_VALUE decimal(26,8) null,
	...
	PS_CURRENCY char(3) null,
	PS_RESPONSE_DATE datetime null,
	TAX_VALUE decimal(26,8) null,
	STAT_GID varchar(255) null,
	SUM_PAID decimal(26,8) null,
	PAY_VOUCHER_NUM varchar(20) null,
	PAY_VOUCHER_DATE date null,
...
create table if not exists b_sale_cashbox_check (
	...
	INDEX IX_SALE_CHECK_EXTERNAL_UUID (EXTERNAL_UUID)
);
...
create table if not exists b_sale_delivery_yandex_taxi_claims(
    ...
    EXTERNAL_FINAL_PRICE decimal(26,8) DEFAULT NULL,
...
create table if not exists b_sale_entity_label (
	ID INT NOT NULL AUTO_INCREMENT,
	ENTITY_ID INT NOT NULL,
	ENTITY_TYPE VARCHAR(255) NOT NULL,
	...
	LABEL_VALUE TEXT,
	PRIMARY KEY (ID),
	INDEX IX_SALE_LABEL_ENTITY_ID_ENTITY_TYPE (ENTITY_ID, ENTITY_TYPE),
	UNIQUE INDEX IX_SALE_LABEL_ENTITY_ID_ENTITY_TYPE_LABEL_NAME (ENTITY_ID, ENTITY_TYPE, LABEL_NAME)
);
