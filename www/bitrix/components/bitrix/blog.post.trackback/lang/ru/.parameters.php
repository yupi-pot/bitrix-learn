...
$MESS ['BPH_BLOG_VAR'] = "Имя переменной для идентификатора блога";
$MESS ['BPH_POST_VAR'] = "Имя переменной для идентификатора сообщения блога";
$MESS ['BPH_PAGE_VAR'] = "Имя переменной для страницы";
