...
$MESS ['BU_PATH_TO_SEARCH'] = "Search page path template";

$MESS ['BU_BLOG_VAR'] = "Blog identifier variable";
$MESS ['BU_PAGE_VAR'] = "Page variable";
$MESS ['BU_USER_VAR'] = "User ID variable";
